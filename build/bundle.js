var app = (function () {
    ...
    /* src\Space.svelte generated by Svelte v3.23.2 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			t = text(/*space*/ ctx[0]);
    			attr(div, "class", "space svelte-1qynwmr");
    ...
    const connect = () => {
        try {
            if(!connection || connection.readyState >= 2){
                connection = new WebSocket({"env":{"apiUrl":"https://tictactoe.noahgasler.net","wsUrl":"wss://tictactoe.noahgasler.net/ws"}}.env.wsUrl);
    ...
    const nextMove = async (space) => {
        try {
            const response = await fetch(`${{"env":{"apiUrl":"https://tictactoe.noahgasler.net","wsUrl":"wss://tictactoe.noahgasler.net/ws"}}.env.apiUrl}/next-turn/${space}`);
    ...
    const newGame = async () => {
        try {
            await fetch(`${{"env":{"apiUrl":"https://tictactoe.noahgasler.net","wsUrl":"wss://tictactoe.noahgasler.net/ws"}}.env.apiUrl}/reset`);
        } catch (e) {
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "svelte-z56xc0");
    		},
    		m(target, anchor) {
    			insert(target, button, anchor);

    			if (!mounted) {
    				dispose = listen(button, "click", /*reset*/ ctx[6]);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(p, "class", "errorMessage svelte-z56xc0");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "row svelte-z56xc0");
    			attr(div1, "class", "row svelte-z56xc0");
    			attr(div2, "class", "row svelte-z56xc0");
    			attr(main, "class", "svelte-z56xc0");
    		},
    		m(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	async function reset() {
    		$$invalidate(4, errorMessage = await newGame());
    	}
